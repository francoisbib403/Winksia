...
import { Eye, LogOut, Package, User } from "lucide-react";
  ...
  return (
    <PopoverRoot>
      <PopoverTrigger asChild>
        <button
          className={`flex h-12 w-12 cursor-pointer items-center justify-center rounded-full border bg-primary text-primary-foreground ${className}`}
          type="button"
        >
          {hasAvatar ? (
        ...
        >
          ...
          >
            <div className="flex flex-col">
              ...
              <button
                className="cursor-pointer p-2 hover:bg-red-50 text-red-600"
                onClick={() => {
                  onLogout?.();
                }}
                type="button"
